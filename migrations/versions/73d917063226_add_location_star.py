...
def upgrade():
    ...
    location_enum = postgresql.ENUM('front', 'back', 'side', 'hoegi', name='location_enum')
    location_enum.create(op.get_bind())

    op.add_column('cafes', sa.Column('location', sa.Enum('front', 'back', 'side', 'hoegi', name='location_enum'), nullable=True))
